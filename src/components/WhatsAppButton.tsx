...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center justify-center w-14 h-14"
      aria-label="Chat on WhatsApp"
    >
      {/* Pulse Animation */}
      <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-25 pointer-events-none"></div>
      
      {/* Button */}
      <div className="relative flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 group-hover:shadow-xl pointer-events-none">
